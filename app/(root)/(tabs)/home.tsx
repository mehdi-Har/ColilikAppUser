...
const Home = () => {
  ...
  const fetchUserById = async () => {
    try {
      ...
      const userId = "6759c298379dca445eb791f6";
      const response = await fetch(
        `http://192.168.219.192:8080/api/users/${userId}`,
      );
    ...
    <SafeAreaView className="flex-1 bg-gray-100 relative">
      ...
      >
        <View className="bg-blue-700 p-5 items-center">
          <Image source={images.elhouat} className="w-20 h-20 rounded-full" />
          <Text className="text-white text-lg font-bold mt-2">ELMEHDI</Text>
